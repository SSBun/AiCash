#!/bin/bash
# AiCash Installer - Downloads the latest AiCash DMG from GitHub
...
DMG_VERSION=$(echo "$DMG_URL" | sed 's/.*\(AiCash-[0-9.]*\.dmg\).*/\1/')
...
echo "1. Drag AiCash.app to your Applications folder"
echo "2. If macOS shows 'AiCash is damaged' error, run:"
echo "   xattr -rd com.apple.quarantine /Applications/AiCash.app"
echo ""
